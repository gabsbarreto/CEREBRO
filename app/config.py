...
OPENAI_RQ_SCREENING_MAX_TOKENS = int(os.getenv("OPENAI_RQ_SCREENING_MAX_TOKENS", "150000"))
...
MAX_OPENAI_CONCURRENT_REQUESTS = max(
    1,
    int(os.getenv("MAX_OPENAI_CONCURRENT_REQUESTS", os.getenv("RQ_MAX_OPENAI_CONCURRENT_REQUESTS", "15"))),
)
